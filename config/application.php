...
return array(
	'ServerAddress'        => 'reckoning-ro.com',              // This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'              => '',                       // The base URI is the base web root on which your application lies.
	'InstallerPassword'    => 'ReckoningFluxCP2015',         // Installer/updater password.
	...
	'SiteTitle'            => 'Reckoning Ragnarok Online',     // This value is only used if the theme decides to use it.
	'ThemeName'            => array('emphaino', 'default'), // Names of the themes you would like to use.  Themes are in FLUX_ROOT/themes. First theme listed will be default theme.
